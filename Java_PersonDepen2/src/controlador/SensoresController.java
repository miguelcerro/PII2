...
public class SensoresController implements Initializable {
	...
	public void btn_volver(ActionEvent event) throws Exception {
		String vista;
		if (user.getTipoUsuario().equals("supervisor")) {
		...
		InputStream in = SensoresController.class.getResourceAsStream(vista);
		loader.setBuilderFactory(new JavaFXBuilderFactory());
		loader.setLocation(SensoresController.class.getResource(vista));
		...
		if (user.getTipoUsuario().equals("supervisor")) {
			...
			supervisorController.iniData(user);
		}
		else {
			UsuarioController usuarioControler = loader.getController();
			usuarioControler.iniData(user);
		}
